...
public class CartPharmacyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_pharmacy);
...
//        Toast.makeText(getApplicationContext(), ""+dbData, Toast.LENGTH_LONG).show();
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(CartPharmacyActivity.this, PharmacyActivity.class));
            }
        });
        ...
        btnCheckout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it = new Intent(CartPharmacyActivity.this, PharmacyBookActivity.class);
