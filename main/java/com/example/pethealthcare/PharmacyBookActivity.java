...
public class PharmacyBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pharmacy_book);
...
//        String time = intent.getStringExtra("time");
        ...
        btnBooking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(PharmacyBookActivity.this, HomeActivity.class));
            }
        });
